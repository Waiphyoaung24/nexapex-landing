...
/*
 * Stable-fluids WebGL pointer effect adapted from React Bits / PavelDoGreat.
 * Brand-tuned: locked to NexApex cyan (#94fcff), RAINBOW_MODE off by default.
 * Skips on prefers-reduced-motion and pointer:coarse (touch-only) devices.
 */
...
interface SplashCursorProps {
  ...
  COLOR?: string;
  /** z-index for the canvas wrapper. Default 20 (above content, below --z-header=50). */
  zIndex?: number;
}
...
export default function SplashCursor({
  ...
  BACK_COLOR = { r: 0.05, g: 0.08, b: 0.09 },
  TRANSPARENT = true,
  RAINBOW_MODE = false,
  COLOR = "#94fcff",
  zIndex = 20,
