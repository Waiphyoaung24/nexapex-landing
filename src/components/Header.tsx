      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={cn(
            ...
            "rounded-full bg-[#1a2630] cursor-pointer",
            "transition-colors duration-200 hover:bg-[#253a49]",
        ...
        <Sheet>
          <SheetTrigger
            className={cn(
              ...
              "rounded-full bg-[#1a2630] px-6 py-3 cursor-pointer",
              ...
              <div className="px-8 pb-8">
                ...
                <a
                  ...
                  className={cn(
                    ...
                    "transition-all duration-200 hover:bg-[#b0fdff] hover:shadow-[0_0_20px_rgba(148,252,255,0.2)]",
                    "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#94fcff]"
                  )}
                >
                  Book a Consultation
        ...
        <Sheet>
          <SheetTrigger
            className={cn(
              ...
              "transition-colors duration-200 hover:bg-[#c8ccc6]",
