...
export function DemoCard({ title, description, href, icon, usageLabel, tags }: DemoCardProps) {
  return (
    <BorderGlow className="demo-card group" borderRadius={16} glowRadius={36} edgeSensitivity={35}>
      <Link
        href={href}
        className={cn(
          "relative flex flex-col rounded-2xl p-6 md:p-8 h-full",
          "bg-nex-surface border border-white/[0.06]",
          "group-hover:border-[#94fcff]/20 group-hover:bg-nex-surface2",
